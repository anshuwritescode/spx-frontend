  ...
  return (
    <div data-aos="fade-up" className='relative md:flex justify-between  border-color  p-3 rounded-2xl space-x-5'>
        ...
        <div className='my-auto whitespace-nowrap z-20 last_box_right_mobile'>
            <h2 className='text-3xl font-semibold  text-blue-500'>Built for Crypto nomads</h2>
          <p className='text-[14px] mt-3 text-black'> Invite your friends & family, educate <br/> and grow your income together on Dollarhouse</p> 
        </div>
            <div className='flex border-color  p-0.5 w-full  rounded-full'>
                <button onClick={()=>{setTabOpen(1)}} className={`${tabOpen == 1 ? "bg-blue-500  py-2 text-white border-none rounded-full" :   "py-2 text-black border-none rounded-full px-6"} font-semibold sm:w-full w-1/2`}>Features</button>
                <button onClick={()=>{setTabOpen(2)}} className={`${tabOpen == 2 ? "bg-blue-500  py-2 text-white border-none rounded-full" :   "py-2 text-black border-none rounded-full "} font-semibold sm:w-full w-1/2`}>Technology stack</button>
            </div>
           {tabOpen == 1? 
           <div className='width_hundred'>
           {/* <div class="grid-css"></div> */}
            <div className='first-tab border-color  bg-[#357ae8] w-full rounded-2xl p-8 mt-5'>
            <div className='md:flex justify-between my-3 space-x-8'>
                <ul>
                    <li className='pb-5 text-sm flex  text-white'><img src='/tick.svg'/>Referral plan</li>
                    <li className='pb-5 text-sm flex  text-white'><img src='/tick.svg'/>Staking plan</li>
                    <li className='pb-5 text-sm flex  text-white'><img src='/tick.svg'/>Level plans</li>
                </ul>
            ...
            <hr/>
             <div className='md:flex justify-between mt-6'>
                ...
                <div className='h-[40px] bg-[#b96c33] py-2 px-4 rounded-full text-white'>
                     <Link className='' href="#">Join now</Link>
                </div>
             </div>
            </div> </div> :  tabOpen == 2 ?  <div className=' border-color  bg-[#357ae8] rounded-2xl p-8 mt-5 width_hundred'>
            <div className='md:flex justify-between my-3 space-x-8'>
                <ul>
        ...
        <div className='my-auto mx-5 z-20 last_box_right'>
            <h2 className='text-3xl font-semibold  text-blue-500'>Built for crypto nomads</h2>
          <p className='text-black'> Invite your friends & family, educate <br/> and grow your income together.</p>  
        </div>
         </div>
  )
}
