...
const RewardsTransaction = () => {
  return (
    <div className="text-center my-24">
      <div className="flex space-x-2 text-black justify-center max-w-[270px] p-2 mx-auto rounded-3xl bg-[#224BC1] md:w-1/4">
        <span>
          <img src="./star.svg" />
        </span>
      ...
      <h2 className="heading text-[33px] font-semibold text-black my-2 text-center">
        Rewards on every transaction
      </h2>
      <p className="md:w-1/3 mt-5 mb-8 mx-auto text-[15px] text-black">
