      ...
      <div class="blocks-layout align-center mt-12">
        <div class="h2-headline-layout">
          <div
            ...
            class="badge-item"
          >
            <div class="badge-bg bg-blue-500"> 
              <div class="badge-content bg-blue-500">
                <div className="text-white bg-blue-500">Join Smart Profit-X</div>
              </div>
            </div>
          </div>
        ...
        <div class="block-item is-icns p-0 df-item_newtop new_border">
          ...
          >
            <div className="md:w-1/2 ">
              <h3 className="text-3xl font-bold mt-5 md:mt-0 text-black "> <span className="text-[#f3ba2f]">Binance </span> <span className="text-black">Smart Chain</span></h3>
              <p className="text-black mt-3 max-w-[350px]">
              The robust & secure blockchain on which the Smart Profit-X platform is deployed. Smart Profit-X uses BSC network because
               </p>
              <ul className="mt-5 dashboard_ul text-black">
                <li className=" text-black" >
                Robust & reliable 
                </li>
                <li className=" text-black">100% Secure & decentralized</li>
                <li className=" text-black">
                Faster transactions                
                </li>
                <li className=" text-black">
          ...
          >
            <div className="max-w-[250px] relative mt-4  md:mt-0 mx-auto md:mx-0">
              <img className="my-auto mt-5 md:mb-5 mb-[40px] md:mt-[35%]" src="/binance1.png" />
               <p className="text-center absolute left-[30%] bottom-0 text-black font-semibold">House 1</p>
            </div>
            <div className="max-w-[300px] relative mt-4  md:mt-0 mx-auto md:mx-0">
              ...
              <p className="text-center absolute left-[30%] bottom-0 text-black font-semibold">House 5</p>

            </div>
            <div className="max-w-[200px] relative mt-4  md:mt-0 mx-auto md:mx-0">
              <img className="my-5 md:mb-5 mb-[40px]" src="/binance3.png" />
              <p className=" text-center absolute left-[20%] bottom-0 text-black font-semibold">House 15</p>
