      ...
      >
        <div class="container md:flex  mt-28">
            <div className="TOP_IMAGE">
                <img src="/Other 06.svg" className=""/>
            </div>
          <div class="hero-layout">
            ...
            >
              <h1
                ...
                class="hero-display flex text-black"
              >
                The <br/> <span className="text-[#b96c33]">Smart Profit-X </span> platform is coming
              </h1>
              <p
                ...
                class="hero-p text-black"
              >
               The best & advanced networking platform
               deployed on Binance smart chain network, with
               superfast transactions & speed. The crypto staking for all crypto enthusiasts</p>
              <div
